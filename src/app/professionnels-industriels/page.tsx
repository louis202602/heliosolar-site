...
export default function Page() {
  const items = [
    { title: "Toitures d’activité", text: "Exploitez les grandes surfaces disponibles tout en tenant compte des charges, accès, équipements et contraintes d’exploitation.", metric: "36 à 500 kWc" },
    { title: "Industrie", text: "Réduisez les charges énergétiques avec une production dimensionnée autour des courbes de consommation du site." },
    { title: "Agriculture", text: "Valorisez hangars, bâtiments d’élevage et foncier avec une approche adaptée aux contraintes agricoles." },
    { title: "Ombrières", text: "Combinez protection, production et valorisation des parkings sans immobiliser de nouvelle emprise au sol." },
    { title: "Étude économique", text: "Analyse de consommation, scénarios d’autoconsommation, production estimée et lecture des leviers de rentabilité." },
    { title: "Pilotage de projet", text: "Coordination technique, documentation, exécution et contrôle qualité avec un interlocuteur identifié." },
  ];

  return (
    <>
      <PageHero
        eyebrow="Professionnels & industriels"
        title="Transformez vos surfaces en actif énergétique."
        description="HelioSolar conçoit des installations photovoltaïques robustes, lisibles et adaptées aux contraintes réelles de votre activité."
      />
      ...
      <section className="pb-24 sm:pb-28">
        <div className="container-px"><FeatureGrid items={items} /></div>
      </section>
    </>
  );
}
