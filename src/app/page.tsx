  ...
  return (
    <>
      <section className="relative isolate overflow-hidden bg-ocean-950 text-white">
        <div className="solar-grid pointer-events-none absolute inset-0 opacity-40" />
        ...
        <div className="relative container-px grid min-h-[760px] items-center gap-14 py-20 lg:grid-cols-[0.95fr_1.05fr] lg:py-24">
          <div className="hero-rise max-w-3xl">
            ...
            <div className="mt-12 grid max-w-2xl grid-cols-3 gap-5 border-t border-white/10 pt-7">
              ...
              <div><p className="text-2xl font-bold">360°</p><p className="mt-1 text-xs text-ocean-300">Étude, pose et suivi</p></div>
            </div>
          </div>
